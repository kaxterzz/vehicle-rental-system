            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" action="AddVehicleController" class="forms-sample">
                  <!--  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="brand" id="exampleInputEmail3" placeholder="Brand" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Model</label>
                      <input type="text" class="form-control" name="model" id="exampleInputPassword4" placeholder="Model" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Year</label>
                      <input type="text" class="form-control" name="year" id="exampleInputPassword4" placeholder="Year" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Registration Number</label>
                      <input type="text" class="form-control" name="reg_no" id="exampleInputPassword4" placeholder="Registration Number" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Color</label>
                      <input type="text" class="form-control" name="color" id="exampleInputPassword4" placeholder="Color" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Number of Seats</label>
                      <input type="text" class="form-control" name="no_of_seats" id="exampleInputPassword4" placeholder="Number of Seats" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Chassis Number</label>
                      <input type="text" class="form-control" name="chassis_no" id="exampleInputPassword4" placeholder="Chassis Number" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Engine Number</label>
                      <input type="text" class="form-control" name="engine_no" id="exampleInputPassword4" placeholder="Engine Number" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Mileage</label>
                      <input type="text" class="form-control" name="mileage" id="exampleInputPassword4" placeholder="Mileage" required>
                    </div>
                  <!-- <div class="form-group">
                      <label for="exampleInputPassword4">Insurance Coverage</label>
                      <input type="text" class="form-control" name="insurance_coverage" id="exampleInputPassword4" placeholder="Insurance Coverage" required>
                    </div> -->
                    <div class="form-group">
	                    <label for="exampleFormControlSelect2">Insurance Coverage</label>
	                    <select name="insurance_coverage" class="form-control" id="exampleFormControlSelect2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="rate" id="exampleInputPassword4" placeholder="Rate (per day)" required>
                    </div>
